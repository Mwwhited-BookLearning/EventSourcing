...
| 39 | [Release Engineering, Packaging & Supply Chain](#release-engineering-packaging--supply-chain) | Scaffolding & Persistence, Compatibility & Deployment Discipline | Underlying commands verified locally; the CI workflow file itself was deleted 2026-08-27 and confirmed, per direct request, as the deliberate accepted state for this POC — not a gap, revisit only on request (`docs/10-open-questions.md` row 3, resolved) |
