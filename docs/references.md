...
| Event upcaster chains | [Axon Framework — Event Versioning](https://docs.axoniq.io/axon-framework-reference/4.11/events/event-versioning/) | `ADR-018`'s `IEventUpcaster`/`UpcastChain` |
