...
| `architecture-design-guidelines.md` | Cross-cutting compliance/consistency reference — the conventions any new ADR/pattern/domain doc/code change should already follow, organized for review rather than narrated as history |
