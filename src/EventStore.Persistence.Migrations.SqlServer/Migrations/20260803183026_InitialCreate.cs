    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ChildEventId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ParentEventId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogicalClock = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EventId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EntityId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EventType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SchemaVersion = table.Column<int>(type: "int", nullable: false),
                    EventKind = table.Column<int>(type: "int", nullable: false),
                    MaterializationOfEventId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    SchemaStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConflictFlag = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    AttestedActorId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AttestedClaims = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AuthorityStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AuthorityDecisionRef = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    TelemetryPointer = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Signature = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OriginalSequenceNumber = table.Column<long>(type: "bigint", nullable: true),
                    OriginalChainHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImportedFrom = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentValidationMode = table.Column<int>(type: "int", nullable: false),
                    RequiredClaims = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ChangeKind = table.Column<int>(type: "int", nullable: false),
                    EntityIdField = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpcastFromPrevious = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    DowncastToPrevious = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RejectionBehavior = table.Column<int>(type: "int", nullable: false),
                    RequiredSignature = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EventTypeAppId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EventTypeName = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EventTypeVersion = table.Column<int>(type: "int", nullable: false),
